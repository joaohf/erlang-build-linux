...
> **Status: WIP/RFC** - This is a implementation and also PoC for [Linux Build SDK](https://github.com/erlef/erlang-build-proposal/blob/main/linux-build-sdk.md) part of [Erlang Builds proposal](https://github.com/erlef/erlang-build-proposal/tree/main).
